...
#set.board.frdmmcxn236
#  # description: Board_project_template frdmmcxn236
#  set(CONFIG_USE_BOARD_Project_Template_frdmmcxn236 true)

#set.device.MCXN236
#  # description: utilitiy for MCXN236
#  set(CONFIG_USE_device_MCXN236_utility_frdmmcxn236 true)
...
#  # description: Devices_project_template MCXN236
#  set(CONFIG_USE_DEVICES_Project_Template_MCXN236 true)

#  # description: Device MCXN236_startup
#  set(CONFIG_USE_device_MCXN236_startup true)

#  # description: Device MCXN236_cmsis
#  set(CONFIG_USE_device_MCXN236_CMSIS true)
...
#  # description: Device MCXN236_system
#  set(CONFIG_USE_device_MCXN236_system true)
...
#  # description: BOARD_Project_Template frdmmcxn236_om13790host
#  set(CONFIG_USE_BOARD_Project_Template_frdmmcxn236_om13790host true)
...
include_if_use(BOARD_Project_Template_frdmmcxn236)
include_if_use(BOARD_Project_Template_frdmmcxn236_om13790host.MCXN236)
...
include_if_use(DEVICES_Project_Template_MCXN236.MCXN236)
include_if_use(RTE_Device.MCXN236)
include_if_use(component_audio_sai_edma_adapter.MCXN236)
include_if_use(component_button.MCXN236)
include_if_use(component_codec_adapters.MCXN236)
include_if_use(component_codec_i2c.MCXN236)
include_if_use(component_common_task)
include_if_use(component_crc_adapter.MCXN236)
include_if_use(component_cs42888_adapter.MCXN236)
include_if_use(component_ctimer_adapter.MCXN236)
include_if_use(component_da7212_adapter.MCXN236)
...
include_if_use(component_gpio_adapter.MCXN236)
include_if_use(component_i3c_adapter.MCXN236)
include_if_use(component_i3c_bus.MCXN236)
include_if_use(component_i3c_bus_adapter.MCXN236)
include_if_use(component_led.MCXN236)
include_if_use(component_lists.MCXN236)
include_if_use(component_log.MCXN236)
include_if_use(component_log_backend_debugconsole.MCXN236)
include_if_use(component_log_backend_debugconsole_lite.MCXN236)
include_if_use(component_log_backend_ringbuffer.MCXN236)
include_if_use(component_lpi2c_adapter.MCXN236)
include_if_use(component_lpspi_adapter.MCXN236)
include_if_use(component_lptmr_adapter.MCXN236)
include_if_use(component_lpuart_adapter.MCXN236)
include_if_use(component_lpuart_dma_adapter.MCXN236)
include_if_use(component_mem_manager.MCXN236)
include_if_use(component_mem_manager_freertos.MCXN236)
include_if_use(component_mem_manager_light.MCXN236)
include_if_use(component_mflash_common.MCXN236)
include_if_use(component_mflash_dummy.MCXN236)
include_if_use(component_mflash_file.MCXN236)
include_if_use(component_mflash_mcxnx4x_onchip.MCXN236)
include_if_use(component_mrt_adapter.MCXN236)
...
include_if_use(component_ostimer_adapter.MCXN236)
include_if_use(component_panic.MCXN236)
...
include_if_use(component_pwm_ctimer_adapter.MCXN236)
include_if_use(component_reset_adapter.MCXN236)
include_if_use(component_serial_manager.MCXN236)
include_if_use(component_serial_manager_spi.MCXN236)
include_if_use(component_serial_manager_swo.MCXN236)
include_if_use(component_serial_manager_uart.MCXN236)
include_if_use(component_serial_manager_usb_cdc.MCXN236)
include_if_use(component_serial_manager_virtual.MCXN236)
include_if_use(component_sgtl_adapter.MCXN236)
include_if_use(component_software_crc_adapter.MCXN236)
include_if_use(component_software_rng_adapter.MCXN236)
include_if_use(component_timer_manager.MCXN236)
include_if_use(component_wifi_bt_module_config.MCXN236)
include_if_use(component_wifi_bt_module_tx_pwr_limits.MCXN236)
include_if_use(component_wm8904_adapter.MCXN236)
include_if_use(component_wm8960_adapter.MCXN236)
include_if_use(device_MCXN236_CMSIS.MCXN236)
include_if_use(device_MCXN236_startup.MCXN236)
include_if_use(device_MCXN236_system.MCXN236)
include_if_use(device_MCXN236_utility_frdmmcxn236.MCXN236)
include_if_use(driver_cache_lpcac.MCXN236)
include_if_use(driver_camera-common.MCXN236)
include_if_use(driver_camera-device-common.MCXN236)
include_if_use(driver_camera-device-ov7670.MCXN236)
include_if_use(driver_camera-device-sccb.MCXN236)
include_if_use(driver_camera-receiver-common.MCXN236)
include_if_use(driver_cdog.MCXN236)
include_if_use(driver_clock.MCXN236)
include_if_use(driver_cmsis_lpi2c.MCXN236)
include_if_use(driver_cmsis_lpspi.MCXN236)
include_if_use(driver_cmsis_lpuart.MCXN236)
include_if_use(driver_codec.MCXN236)
include_if_use(driver_common.MCXN236)
include_if_use(driver_crc.MCXN236)
include_if_use(driver_cs42888.MCXN236)
include_if_use(driver_ctimer.MCXN236)
include_if_use(driver_dbi.MCXN236)
include_if_use(driver_dbi_flexio_edma.MCXN236)
include_if_use(driver_dbi_flexio_smartdma.MCXN236)
include_if_use(driver_dialog7212.MCXN236)
include_if_use(driver_edma4.MCXN236)
include_if_use(driver_edma_soc.MCXN236)
include_if_use(driver_eim.MCXN236)
include_if_use(driver_erm.MCXN236)
include_if_use(driver_evtg.MCXN236)
include_if_use(driver_ewm.MCXN236)
include_if_use(driver_flashiap.MCXN236)
include_if_use(driver_flexcan.MCXN236)
include_if_use(driver_flexcan_edma.MCXN236)
include_if_use(driver_flexio.MCXN236)
include_if_use(driver_flexio_i2c_master.MCXN236)
include_if_use(driver_flexio_mculcd.MCXN236)
include_if_use(driver_flexio_mculcd_edma.MCXN236)
include_if_use(driver_flexio_mculcd_smartdma.MCXN236)
include_if_use(driver_flexio_spi.MCXN236)
include_if_use(driver_flexio_spi_edma.MCXN236)
include_if_use(driver_flexio_uart.MCXN236)
include_if_use(driver_flexio_uart_edma.MCXN236)
include_if_use(driver_ft5406.MCXN236)
include_if_use(driver_ft5406_rt.MCXN236)
include_if_use(driver_ft6x06.MCXN236)
include_if_use(driver_fxos8700cq.MCXN236)
include_if_use(driver_gpio.MCXN236)
include_if_use(driver_gt911.MCXN236)
include_if_use(driver_i3c.MCXN236)
include_if_use(driver_i3c_edma.MCXN236)
include_if_use(driver_ili9341.MCXN236)
include_if_use(driver_inputmux.MCXN236)
include_if_use(driver_inputmux_connections.MCXN236)
include_if_use(driver_intm.MCXN236)
include_if_use(driver_irtc.MCXN236)
include_if_use(driver_itrc.MCXN236)
include_if_use(driver_lpadc.MCXN236)
include_if_use(driver_lpc_freqme.MCXN236)
include_if_use(driver_lpc_smartdma.MCXN236)
include_if_use(driver_lpcmp.MCXN236)
include_if_use(driver_lpflexcomm.MCXN236)
include_if_use(driver_lpflexcomm_lpi2c_freertos.MCXN236)
include_if_use(driver_lpflexcomm_lpspi_freertos.MCXN236)
include_if_use(driver_lpflexcomm_lpuart_freertos.MCXN236)
include_if_use(driver_lpi2c.MCXN236)
include_if_use(driver_lpi2c_edma.MCXN236)
include_if_use(driver_lpspi.MCXN236)
include_if_use(driver_lpspi_edma.MCXN236)
include_if_use(driver_lptmr.MCXN236)
include_if_use(driver_lpuart.MCXN236)
include_if_use(driver_lpuart_edma.MCXN236)
include_if_use(driver_mcx_cmc.MCXN236)
include_if_use(driver_mcx_spc.MCXN236)
include_if_use(driver_mcx_vbat.MCXN236)
include_if_use(driver_mem_interface.MCXN236)
include_if_use(driver_mma8451q.MCXN236)
include_if_use(driver_mma8652fc.MCXN236)
include_if_use(driver_mrt.MCXN236)
include_if_use(driver_mx25r_flash.MCXN236)
include_if_use(driver_nand_flash-common.MCXN236)
include_if_use(driver_nor_flash-common.MCXN236)
include_if_use(driver_nor_flash-controller-lpspi.MCXN236)
include_if_use(driver_ostimer.MCXN236)
include_if_use(driver_p3t1755.MCXN236)
include_if_use(driver_pdm.MCXN236)
include_if_use(driver_pdm_edma.MCXN236)
include_if_use(driver_pf1550.MCXN236)
include_if_use(driver_pf3000.MCXN236)
include_if_use(driver_phy-common.MCXN236)
include_if_use(driver_phy-device-lan8741.MCXN236)
include_if_use(driver_pint.MCXN236)
include_if_use(driver_port.MCXN236)
include_if_use(driver_puf_v3.MCXN236)
include_if_use(driver_pwm.MCXN236)
include_if_use(driver_qdc.MCXN236)
include_if_use(driver_reset.MCXN236)
include_if_use(driver_rtt.MCXN236)
include_if_use(driver_rtt_template.MCXN236)
include_if_use(driver_runbootloader.MCXN236)
include_if_use(driver_sai.MCXN236)
include_if_use(driver_sai_edma.MCXN236)
include_if_use(driver_sgtl5000.MCXN236)
include_if_use(driver_ssd1963.MCXN236)
include_if_use(driver_st7796s.MCXN236)
include_if_use(driver_syspm.MCXN236)
include_if_use(driver_tdet.MCXN236)
include_if_use(driver_utick.MCXN236)
include_if_use(driver_video-common.MCXN236)
include_if_use(driver_vref_1.MCXN236)
include_if_use(driver_wm8904.MCXN236)
include_if_use(driver_wm8960.MCXN236)
include_if_use(driver_wuu.MCXN236)
include_if_use(driver_wwdt.MCXN236)
include_if_use(middleware_baremetal.MCXN236)
...
include_if_use(utilities_misc_utilities.MCXN236)
include_if_use(utilities_unity.MCXN236)
include_if_use(utility_assert.MCXN236)
include_if_use(utility_assert_lite.MCXN236)
include_if_use(utility_debug_console.MCXN236)
include_if_use(utility_debug_console_lite.MCXN236)
include_if_use(utility_incbin.MCXN236)
include_if_use(utility_notifier.MCXN236)
include_if_use(utility_shell.MCXN236)
include_if_use(utility_str.MCXN236)
